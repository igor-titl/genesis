...
(function () {
  ...
  var CONNECTORS = [
    ...
    "Apache Airflow","AWS","Azure","Railway","Google Cloud","dbt Cloud",
  ...
  var CONNECTOR_CATS = {
    ...
    Cloud: ["AWS","Azure","Google Cloud","Railway","Microsoft OneDrive","Microsoft SharePoint","Google Workspace","Google Search"],
  ...
  var LOCAL_SVG = {
    ...
    Azure: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g transform="scale(0.6667 0.8571)"><path d="M16.5188 26.1799C21.1063 25.3695 24.8953 24.6989 24.9388 24.6897L25.0179 24.6729L20.6869 19.5213C18.3048 16.6879 16.3558 14.3586 16.3558 14.3452C16.3558 14.3198 20.828 2.00445 20.8531 1.96064C20.8615 1.94599 23.905 7.2004 28.2306 14.6977C32.2804 21.7168 35.6192 27.504 35.6502 27.5583L35.7067 27.6569L21.9423 27.6551L8.17792 27.6533L16.5188 26.1799ZM0 24.6089C0 24.6016 2.04076 21.059 4.53503 16.7364L9.07005 8.87717L14.3551 4.44195C17.2619 2.00258 19.648 0.00374559 19.6575 0.000100201C19.6671 -0.00354446 19.6289 0.0926958 19.5726 0.213969C19.5163 0.335241 16.9338 5.87436 13.8337 12.5231L8.1973 24.6118L4.09865 24.6169C1.84439 24.6197 0 24.6161 0 24.6089Z" fill="#000"/></g></svg>',
    "Azure OpenAI": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g transform="scale(0.6667 0.8571)"><path d="M16.5188 26.1799C21.1063 25.3695 24.8953 24.6989 24.9388 24.6897L25.0179 24.6729L20.6869 19.5213C18.3048 16.6879 16.3558 14.3586 16.3558 14.3452C16.3558 14.3198 20.828 2.00445 20.8531 1.96064C20.8615 1.94599 23.905 7.2004 28.2306 14.6977C32.2804 21.7168 35.6192 27.504 35.6502 27.5583L35.7067 27.6569L21.9423 27.6551L8.17792 27.6533L16.5188 26.1799ZM0 24.6089C0 24.6016 2.04076 21.059 4.53503 16.7364L9.07005 8.87717L14.3551 4.44195C17.2619 2.00258 19.648 0.00374559 19.6575 0.000100201C19.6671 -0.00354446 19.6289 0.0926958 19.5726 0.213969C19.5163 0.335241 16.9338 5.87436 13.8337 12.5231L8.1973 24.6118L4.09865 24.6169C1.84439 24.6197 0 24.6161 0 24.6089Z" fill="#000"/></g></svg>'
  };
  ...
  function render() {
    ...
    for (var i = 0; i < LAYOUT.length; i++) {
      ...
      if (hoveredCenter) {
        ...
        if (ha > 0.01) {
          lineAlpha = 0.09 + ha * 0.45;
          lineColor = "rgba(" + catColor + "," + lineAlpha + ")";
          lineWidth = 1.0 + ha * 1.1;
          if (ha > 0.1) {
            ctx.beginPath(); ctx.moveTo(startX, startY); ctx.lineTo(endX, endY);
            ctx.strokeStyle = "rgba(" + catColor + "," + (ha * 0.08) + ")";
            ctx.lineWidth = 8.5; ctx.stroke();
          }
        } else {
          lineAlpha = 0.06;
